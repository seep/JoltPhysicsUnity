...
namespace Jolt
{
    internal static unsafe partial class Bindings
    {
        ...
        public static NativeHandle<JPH_BodyCreationSettings> JPH_BodyCreationSettings_Create(NativeHandle<JPH_ShapeSettings> settings, rvec3 position, quaternion rotation, MotionType motion, ObjectLayer layer)
        {
            AssertInitialized();
        ...
        public static NativeHandle<JPH_BodyCreationSettings> JPH_BodyCreationSettings_Create(NativeHandle<JPH_Shape> shape, rvec3 position, quaternion rotation, MotionType motion, ObjectLayer layer)
        {
            AssertInitialized();
