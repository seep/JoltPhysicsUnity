...
namespace Jolt
{
    internal static unsafe partial class SafeBindings
    {
        ...
        {
            Bindings.JPH_PhysicsSystem_Destroy(system);
        ...
        {
            Bindings.JPH_PhysicsSystem_OptimizeBroadPhase(system);
        }
        ...
        {
            return Bindings.JPH_PhysicsSystem_Step(system, deltaTime, collisionSteps);
        }

        public static NativeHandle<JPH_BodyInterface> JPH_PhysicsSystem_GetBodyInterface(NativeHandle<JPH_PhysicsSystem> system)
        {
            return CreateOwnedHandle(system, Bindings.JPH_PhysicsSystem_GetBodyInterface(system));
        }
        ...
        {
            return CreateOwnedHandle(system, Bindings.JPH_PhysicsSystem_GetBodyInterfaceNoLock(system));
        }
        ...
        {
            return CreateOwnedHandle(system, Bindings.JPH_PhysicsSystem_GetBodyLockInterface(system));
        }
        ...
        {
            return CreateOwnedHandle(system, Bindings.JPH_PhysicsSystem_GetBodyLockInterfaceNoLock(system));
        }
        ...
        {
            return CreateOwnedHandle(system, Bindings.JPH_PhysicsSystem_GetNarrowPhaseQuery(system));
        }
        ...
        {
            return CreateOwnedHandle(system, Bindings.JPH_PhysicsSystem_GetNarrowPhaseQueryNoLock(system));
        }
        ...
        {
            Bindings.JPH_PhysicsSystem_SetContactListener(system, listener);
        }
        ...
        public static float3 JPH_PhysicsSystem_GetGravity(NativeHandle<JPH_PhysicsSystem> system)
        {
            ...
            Bindings.JPH_PhysicsSystem_GetGravity(system, &gravity);
