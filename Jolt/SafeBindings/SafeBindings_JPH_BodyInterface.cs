...
namespace Jolt
{
    internal static unsafe partial class SafeBindings
    {
        ...
        {
            Bindings.JPH_BodyInterface_DestroyBody(@interface, bodyID);
        ...
        {
            return Bindings.JPH_BodyInterface_CreateAndAddBody(@interface, settings, activation);
        }
        ...
        {
            return CreateHandle(Bindings.JPH_BodyInterface_CreateBody(@interface, settings));
        }
        ...
        {
            return CreateHandle(Bindings.JPH_BodyInterface_CreateSoftBody(@interface, settings));
        }
        ...
        {
            return CreateHandle(Bindings.JPH_BodyInterface_CreateBodyWithID(@interface, bodyID, settings));
        }
        ...
        {
            return CreateHandle(Bindings.JPH_BodyInterface_CreateBodyWithoutID(@interface, settings));
        }
        ...
        {
            Bindings.JPH_BodyInterface_DestroyBodyWithoutID(@interface, body);
        }

        public static bool JPH_BodyInterface_AssignBodyID(NativeHandle<JPH_BodyInterface> @interface, NativeHandle<JPH_Body> body)
        {
            return Bindings.JPH_BodyInterface_AssignBodyID(@interface, body);
        }
        ...
        {
            return Bindings.JPH_BodyInterface_AssignBodyID2(@interface, body, bodyID);
        }
        ...
        {
            Bindings.JPH_BodyInterface_SetLinearVelocity(@interface, bodyID, &velocity);
        }
        ...
        public static float3 JPH_BodyInterface_GetLinearVelocity(NativeHandle<JPH_BodyInterface> @interface, BodyID bodyID)
        {
            ...
            Bindings.JPH_BodyInterface_GetLinearVelocity(@interface, bodyID, &result);
        ...
        public static rvec3 JPH_BodyInterface_GetCenterOfMassPosition(NativeHandle<JPH_BodyInterface> @interface, BodyID bodyID)
        {
            ...
            Bindings.JPH_BodyInterface_GetCenterOfMassPosition(@interface, bodyID, &result);
        ...
        {
            return Bindings.JPH_BodyInterface_GetMotionType(@interface, bodyID);
        }
        ...
        {
            Bindings.JPH_BodyInterface_SetMotionType(@interface, bodyID, motion, activation);
        }

        public static float JPH_BodyInterface_GetRestitution(NativeHandle<JPH_BodyInterface> @interface, BodyID bodyID)
        {
            return Bindings.JPH_BodyInterface_GetRestitution(@interface, bodyID);
        }
        ...
        {
            Bindings.JPH_BodyInterface_SetPosition(@interface, bodyID, &position, activation);
        }
        ...
        public static rvec3 JPH_BodyInterface_GetPosition(NativeHandle<JPH_BodyInterface> @interface, BodyID bodyID)
        {
            ...
            Bindings.JPH_BodyInterface_GetPosition(@interface, bodyID, &result);
        ...
        {
            Bindings.JPH_BodyInterface_SetRotation(@interface, bodyID, &rotation, activation);
        }
        ...
        public static quaternion JPH_BodyInterface_GetRotation(NativeHandle<JPH_BodyInterface> @interface, BodyID bodyID)
        {
            ...
            Bindings.JPH_BodyInterface_GetRotation(@interface, bodyID, &result);
        ...
        public static rmatrix4x4 JPH_BodyInterface_GetWorldTransform(NativeHandle<JPH_BodyInterface> @interface, BodyID bodyID)
        {
            ...
            Bindings.JPH_BodyInterface_GetWorldTransform(@interface, bodyID, &result);
