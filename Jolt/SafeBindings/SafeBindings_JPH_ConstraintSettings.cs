namespace Jolt
{
    internal static unsafe partial class SafeBindings
    {
        ...
        {
            Bindings.JPH_FixedConstraintSettings_SetConstraintPriority(settings, value);
        }

        public static uint JPH_ConstraintSettings_GetNumVelocityStepsOverride(NativeHandle<JPH_ConstraintSettings> settings)
        {
            return Bindings.JPH_ConstraintSettings_GetNumVelocityStepsOverride(settings);
        }
        ...
        {
            Bindings.JPH_ConstraintSettings_SetNumVelocityStepsOverride(settings, value);
        }

        public static uint JPH_ConstraintSettings_GetNumPositionStepsOverride(NativeHandle<JPH_ConstraintSettings> settings)
        {
            return Bindings.JPH_ConstraintSettings_GetNumPositionStepsOverride(settings);
        }
