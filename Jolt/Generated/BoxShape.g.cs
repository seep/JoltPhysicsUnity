...
namespace Jolt
{
    public partial struct BoxShape : IEquatable<BoxShape>
    {
        #region IEquatable
        ...
        public float3 GetHalfExtent() => SafeBindings.JPH_BoxShape_GetHalfExtent(Handle);
        
        public float GetConvexRadius() => SafeBindings.JPH_BoxShape_GetConvexRadius(Handle);
