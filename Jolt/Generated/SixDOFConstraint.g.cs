...
namespace Jolt
{
    public partial struct SixDOFConstraint : IEquatable<SixDOFConstraint>
    {
        #region IEquatable
        ...
        public SixDOFConstraintSettings GetSettings() => Bindings.JPH_SixDOFConstraint_GetSettings(Handle);
