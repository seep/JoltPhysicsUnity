...
namespace Jolt
{
    public partial struct CapsuleShape : IEquatable<CapsuleShape>
    {
        #region IEquatable
        ...
        public float GetRadius() => SafeBindings.JPH_CapsuleShape_GetRadius(Handle);
        
        public float GetHalfHeightOfCylinder() => SafeBindings.JPH_CapsuleShape_GetHalfHeightOfCylinder(Handle);
